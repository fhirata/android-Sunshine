...
import static com.example.fabiohh.sunshine.app.data.WeatherContract.CONTENT_AUTHORITY;
import static com.example.fabiohh.sunshine.app.data.WeatherContract.PATH_LOCATION;
import static com.example.fabiohh.sunshine.app.data.WeatherContract.PATH_WEATHER;
...
public class WeatherProvider extends ContentProvider {
    ...
    private void normalizeDate(ContentValues values) {
        ...
        if (values.containsKey(WeatherContract.WeatherEntry.COLUMN_DATE)) {
            ...
            values.put(WeatherContract.WeatherEntry.COLUMN_DATE, Long.valueOf(dateValue));
        }
    }
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case LOCATION: {
                rowsImpacted = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            }
            case WEATHER: {
                rowsImpacted = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
