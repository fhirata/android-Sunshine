...
import static com.example.fabiohh.sunshine.app.data.WeatherContract.LocationEntry.COLUMN_CITY_NAME;
...
public class SunshineService extends IntentService {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                ContentValues[] weatherValuesArray = new ContentValues[cVVector.size()];
                cVVector.toArray(weatherValuesArray);
                this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, weatherValuesArray);
            }
        } catch (JSONException e) {
            Log.e(LOG_TAG, e.getMessage(), e);
            e.printStackTrace();
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            Uri returnUri = this.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
            locationId = ContentUris.parseId(returnUri);
            this.getContentResolver().notifyChange(WeatherContract.LocationEntry.CONTENT_URI, null);
        }
