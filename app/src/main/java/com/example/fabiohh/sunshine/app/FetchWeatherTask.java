...
import static com.example.fabiohh.sunshine.app.data.WeatherContract.LocationEntry;
...
import static com.example.fabiohh.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            mContext.getContentResolver().notifyChange(LocationEntry.CONTENT_URI, null);
        }
